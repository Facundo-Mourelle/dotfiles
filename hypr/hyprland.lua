...
-- Custom Automation Script Invocation
hl.bind(mainMod .. " + H", hl.dsp.exec_cmd("~/.config/hypr/scripts/utils.sh"))
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("~/.config/hypr/scripts/power_menu.sh"))
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd("~/.config/hypr/scripts/screenshot.sh"))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd("~/.config/hypr/scripts/tmux-cheatsheet.sh"))

-- Internal Window Management and Tiling Overrides
...
-- XWayland Unmanaged Drag Surface Deadlock Mitigation
hl.window_rule({
...
hl.window_rule({
	name = "help-hint-overlay",
	match = { class = "helpHint" },
	float = true,
	center = true,
	size = "800 500",
	no_anim = true,
...
-- Tiled Workspace Geometry Padding Collapse
hl.workspace_rule({ workspace = "w[tv1]", gaps_out = 0, gaps_in = 0 })
hl.window_rule({ match = { float = false, workspace = "w[tv1]" }, border_size = 0, rounding = 0 })

-- Floating Workspace Geometry Padding Collapse
